  ...
  .command("cicd", "command for starting a cicd test suite", yargs => {
    yargs
      .options({
        ...
        oracle: {
          type: "string",
          description: `Test oracle which determines if the LUIS output is correct, can be "overallIntent", "allEntities" or "specificEntity". If "specificEntity", "specificEntityId" arg is required`,
          demandOption: true,
        },
        specificEntityId: {
          type: "number",
          description: `Specific entity ID if oracle is set to "specificEntity". 1: origin city, 2: destination city, 3: budget, 4: start date, 5: number of children, 6: number of adults`,
        },
        spellCheck: {
          type: "boolean",
